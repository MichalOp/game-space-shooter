...
public final class Consts {
    public static final double SHIP_MAX_ACCELERATION = 10;
    public static final double MISSILE_MAX_ACCELERATION = 30;
    ...
    public static final int COLOR_0 = 0x00ff00;
    public static final int COLOR_1 = 0x0000ff;
    public static final int LIFE_BAR_WIDTH  = 50;
}
